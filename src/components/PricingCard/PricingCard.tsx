...
const PricingCard: FC<Props> = ({ image, isFocused }) => {
  return (
    <>
      ...
      <div className={`${styles.card__blur} ${isFocused && styles['card__blur--active']}`} />
      {isFocused ? (
        <div className={styles.card__content}>
          <p className={styles.card__title}>CAD Design</p>
          <div className={styles.card__center}>
            <SeparatorLine inverseAnim />
            <p className={styles.card__text}>Straightforward designs without stones, including revisions*</p>
            <SeparatorLine />
          </div>
...
const SeparatorLine: FC<PropsLine> = ({inverseAnim}) => (
  <div className={`${styles.container_line_wrapper} ${inverseAnim && styles['container_line_wrapper--inverse-animation']}`}>
