    ...
    <Styled.ContentWrapper>
      ...
      <Styled.ContentPage>
        <Styled.ContentDepartment>
          ...
          <QuestionAnswer
            question={'Navigate to the ‘Account’ page and click ‘Create Account.’ Then, fill in your Name\n' +
          ...
          <QuestionAnswer
            question={'Navigate to the ‘Account’ page and click ‘Create Account.’ Then, fill in your Name\n' +
              'and Email as required.'}
            summary={'What are the benefits of having a Bravo Creation account?'}
          />
        </Styled.ContentDepartment>
        <Styled.ContentDepartment>
        ...
        <Styled.RegistrationField>
          <Styled.RgistrationLeftContainer>
            <Styled.RegistrationText>
              Stop Wasting <Styled.YellowText>You Time</Styled.YellowText>
            </Styled.RegistrationText>
            <Styled.RegistrationDescription>
              The jewelry designer explores
              different materials to create exclusive jewelry that highlights each client's personality and style.
            </Styled.RegistrationDescription>
          </Styled.RgistrationLeftContainer>
          <hr style={{ height: '100%', borderColor: 'rgba(255, 255, 255, 0.10)'}}/>
          <Styled.RgistrationLeftContainer>
