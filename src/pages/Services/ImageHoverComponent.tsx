...
const ImageHoverComponent: React.FC<Props> = ({ image, title, text }) => {
  ...
  return (
    <div onMouseEnter={toggleOverlay} onMouseLeave={toggleOverlay} className={styles.container}>
      <img src={image} className={cn(styles.container_image, {
        [styles['container_image--dark']]: isTextShown,
      })}/>
      <p className={cn(styles.container_title, {
      ...
      {isTextShown ? (
        <>
          <div className={styles.container_line_wrapper}>
            ...
            <div className={cn(styles.container_line, styles['container_line--vertical'])} />
            <div className={cn(styles.container_line, styles['container_line--vertical'])} />
            <div className={styles.container_line} />
            <div className={cn(styles.container_line, styles['container_line--vertical'])} />
            <div className={cn(styles.container_line, styles['container_line--vertical'])} />
